...
const Contact = () => {
  return (
    <>
      <div className="px-5 py-6 bg-sky-950 grid grid-cols-1 gap-4 lg:px-20">
        <h1 className="text-2xl font-semibold text-slate-300 lg:text-6xl mb-5">
        ...
        <div className="mb-20 flex justify-between items-center lg:m-0">
          ...
          <p className="text-xs font-semibold text-slate-300 lg:text-lg">
